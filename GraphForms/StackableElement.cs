...
namespace GraphForms
{
    ...
    {
        private StackableElement parent;
        private int siblingIndex;
        private List<StackableElement> children = new List<StackableElement>();
        ...
        public bool IsAncestorOf(StackableElement child)
        {
            if (child == null || child == this)
                return false;
            if (child.Depth < this.Depth)
                return false;
            StackableElement ancestor = child.parent;
            while (ancestor != null)
            {
                if (ancestor == this)
                    return true;
        ...
        public StackableElement CommonAncestor(StackableElement other)
        {
            if (other == null)
                return null;
            if (other == this)
                return this;
            StackableElement thisw = this;
            StackableElement otherw = other;
        ...
        public static bool ClosestLeaf(StackableElement item1, StackableElement item2)
        {
        ...
        public static bool ClosestItemFirst(StackableElement item1, StackableElement item2)
        {
            ...
            StackableElement p = item1.parent;
            StackableElement t1 = item1;
            ...
            StackableElement p1 = t1;
            StackableElement p2 = t2;
            while (t1 != null && t1 != t2)
            {
                p1 = t1;
                p2 = t2;
        ...
        private static int notClosestLeaf(StackableElement item1, StackableElement item2)
        {
        ...
        private void EnsureSortedChildren()
        {
            if (this.needSortChildren)
            {
                ...
                if (children.Count == 0)
                    return;
                this.children.Sort(new Comparison<StackableElement>(notClosestLeaf));
        ...
        private static int insertOrder(StackableElement a, StackableElement b)
        {
        ...
        private void EnsureSequentialSiblingIndex()
        {
            ...
            {
                this.children.Sort(new Comparison<StackableElement>(insertOrder));
                this.sequentialOrdering = true;
        ...
        /// </remarks>
        public bool StackBefore(StackableElement sibling)
        {
            if (sibling == this)
                return false;
            ...
            List<StackableElement> siblings = this.parent != null
        ...
        /// </summary>
        public StackableElement[] Children
        {
            get
            {
        ...
        private void AddChild(StackableElement child)
        {
        ...
        private void RemoveChild(StackableElement child)
        {
        ...
        public StackableElement Parent
        {
            get { return this.parent; }
        }

        public bool SetParent(StackableElement parent)
        {
            // TODO: Insert pre-notification (with possible adjustment?)
            ...
            StackableElement oldParent = this.parent;
            this.parent = parent;
        ...
        protected virtual void OnParentChanging(StackableElement newParent)
        {
        }

        protected virtual void OnParentChanged(StackableElement oldParent)
        {
        }
        #endregion
    }
